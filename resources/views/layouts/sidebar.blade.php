        ...
        @auth
            ...
            <div class="bg-slate-800/60 rounded-xl p-3.5 border border-slate-700/50">
                ...
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <div class="w-9 h-9 rounded-full bg-sky-600 flex items-center justify-center text-white font-bold text-sm">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    ...
                    <button type="submit"
                        class="w-full bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg text-sm transition">
